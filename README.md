...
<head>
  ...
  <meta name="description" content="Zorem Editz - Epic Anime Shorts | JJK, Solo Leveling & More!">
  <meta name="keywords" content="anime edits, Zorem Editz, Jujutsu Kaisen edits, Solo Leveling shorts, YouTube anime shorts">
  <meta name="author" content="Zorem Editz">

  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&display=swap" rel="stylesheet">
  <link rel="icon" type="image/png" href="https://i.ibb.co/SKzrx4Y/zorem-logo.png">
...
<body>
  ...
  <section id="comments" class="section">
    ...
    <script>
      var disqus_config = function () {
        ...
        this.page.identifier = 'zorem_editz_page';
      };
      (function () {
  ...
  <section id="contact" class="section">
    ...
    <p>
      ...
      📸 Instagram: <a href="https://www.instagram.com/Zorem_Editz" target="_blank">@Zorem_Editz</a>
    </p>
  </section>

  <footer>
    <p>&copy; 2025 Zorem Editz | Designed with ❤️ for Anime</p>
  </footer>
